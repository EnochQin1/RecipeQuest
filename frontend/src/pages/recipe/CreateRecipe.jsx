...
function CreateRecipe() {
    ...
    const handleSave = (event) => {
        /*if (!recipeImage) {
            setImageError('Please upload an image for the recipe.');
            return;
        }*/
    ...
    const saveRecipe = async () => {
        ...
        await fetch('api/recipes/', {
            ...
            alert("Please fill out all fields. Recipe not saved")
        })
    ...
    return (
        <div>
            ...
            <Form noValidate validated={validated} onSubmit={handleSave} style={{ marginTop: 120, paddingBottom: 200 }}>
                <Row className='Header' >
                    <Form.Group as={Col} controlId='recipeHeader'>
                        <h1 style={{ fontFamily: 'Roboto', fontSize: 27 }}>Upload Recipe</h1>
                    </Form.Group>
                ...
                <Row className='Recipe Categories' style={{ marginTop: 20 }}>
                    <Stack spacing={2} direction='col' sx={{ width: 'auto' }}>
                        <Autocomplete
                            ...
                            freeSolo
                            autoSelect
                            id='catagory-autocomplete'
                            label='Add Category'
                            className='recipeCatagory'
                            value={userBadge}
                ...
                <Row className='Difficulty'>
                    <Stack spacing={2.5
                    } direction='row' style={{ width: 'auto' }}>
                        <div>
                            ...
                            <Select
                                ...
                                onBlur={() => setValidDifficulty(recipeDifficulty !== '')}
                                error={!validDifficulty}
                                helperText={!validDifficulty ? 'Please select a difficulty' : ''}
